...
public class GerenciadorFuncionario {
    ...
    public static GerenciadorFuncionario initialize(){
        Funcionario f1 = new Funcionario("João", "Maruca", "12.234.567-8", "321.321.321-55", LocalDate.of(1999, Month.MARCH, 17), 0, "123456789", 1500, LocalDate.of(2015, Month.MARCH, 12), "Alimentação");
        Funcionario f2 = new Funcionario("Felipe", "Labate", "12.546.525-5", "123.654.789-88", LocalDate.of(1997, Month.AUGUST, 13), 0, "321654789", 1500, LocalDate.of(2016, Month.AUGUST, 5), "Almoxarifado");
        Funcionario f3 = new Funcionario("Gabriel", "Alcântara", "32.654.789-8", "456.456.456-54", LocalDate.of(1998, Month.DECEMBER, 4), 1, "456789245", 1250, LocalDate.of(2017, Month.JANUARY, 5), "Alimentação");
        Funcionario f4 = new Funcionario("Carlos", "Eduardo", "45.852.369-4", "444.555.666-87", LocalDate.of(1998, Month.JUNE, 18), 1, "78965412", 1600, LocalDate.of(2014, Month.MARCH, 13), "Segurança");
        Funcionario f5 = new Funcionario("Santiago", "Saraiva", "74.546.528-4", "564.789.654-52", LocalDate.of(1997, Month.MAY, 25), 2, "12345678", 1500, LocalDate.of(2010, Month.DECEMBER, 26), "Aquisições");
        Funcionario f6 = new Funcionario("José", "Silva", "45.456.456-7", "123.123.123-55", LocalDate.of(1975, Month.JULY, 24), 2, "123456789", 2000, LocalDate.of(2005, Month.FEBRUARY, 12), "Administação");
